...
// The SYNAP brand mark (transparent imageset generated by @bacons/apple-targets
// from targets/widget/synap-mark.png). Used as the Live Activity glyph.
private struct SynapMarkIcon: View {
  var size: CGFloat
  var body: some View {
    Image("SynapMark")
      .resizable()
