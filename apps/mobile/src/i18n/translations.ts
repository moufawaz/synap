...
export const t: Record<Language, TranslationMap> = {
  en: {
    ...
    progress: 'Progress',
    more: 'More',
    launchAccess: 'Launch access active. All features are unlocked.',
    askIon: 'Ask Ion anything...',
    todayWorkout: "Today's workout",
    todaysMeals: "Today's meals",
    comingNext: 'Native build in progress',
  ...
  ar: {
    ...
    progress: 'التقدم',
    more: 'المزيد',
    launchAccess: 'وصول الإطلاق مفعل. كل الميزات مفتوحة.',
    askIon: 'اسأل آيون أي شيء...',
    todayWorkout: 'تمرين اليوم',
    todaysMeals: 'وجبات اليوم',
    comingNext: 'بناء التطبيق الأصلي قيد التنفيذ',
