...
const EN = {
  ...
  plans: [
    ...
    },
    {
      ...
      annualSAR: 319.99,
      priceLabel: '',
      features:  ['Unlimited Ion messages / day', 'Everything in Starter', '7-day free trial', 'Barcode food scanner', 'Proactive check-ins', 'Plan renewal that learns'],
    ...
    },
    {
      ...
      annualSAR: 559.99,
      priceLabel: '',
      features:  ['Everything in Pro', '7-day free trial', 'Goal timeline prediction', 'Weekly body composition report', 'Supplement recommendations'],
      missing:   [] as string[],
      cta:       'Try Free for 7 Days',
      href:      '/pricing',
      hero:      false,
...
const AR = {
  ...
  plans: [
    ...
    },
    {
      ...
      annualSAR: 319.99,
      priceLabel: '',
      features:  ['رسائل Ion غير محدودة يومياً', 'كل مزايا المجاني', 'تجربة مجانية 7 أيام', 'ماسح باركود الطعام', 'متابعة استباقية', 'تجديد الخطة الذكي'],
    ...
    },
    {
      ...
      annualSAR: 559.99,
      priceLabel: '',
      features:  ['كل مزايا برو', 'تجربة مجانية 7 أيام', 'التنبؤ بالجدول الزمني للهدف', 'تقرير تركيبة الجسم الأسبوعي', 'توصيات المكملات الغذائية'],
      missing:   [] as string[],
      cta:       'جرب مجاناً 7 أيام',
      href:      '/pricing',
      hero:      false,
