  ...
  plans: [
    {
      ...
      features:   ['5 Ion messages / day', 'Adaptive diet plan', 'Smart workout program', 'Body tracking (13 measurements)', 'Grocery list generator', 'Bilingual Arabic + English'],
      missing:    ['Unlimited messages', 'Barcode scanner', 'Eating out guidance'],
      cta:        'Start Free',
      href:       '/auth/signup',
      hero:       false,
    },
    {
      ...
      priceLabel: '',
      features:  ['Unlimited Ion messages / day', 'Everything in Starter', '7-day free trial', 'Barcode food scanner', 'Eating out & meal recipes', 'Proactive check-ins', 'Plan renewal that learns', 'Progress photo storage'],
  ...
  plans: [
    {
      ...
      features:   ['5 رسائل يومياً مع Ion', 'خطة غذائية تكيفية', 'برنامج تمرين ذكي', 'تتبع الجسم (13 قياساً)', 'مولّد قائمة التسوق', 'ثنائي اللغة عربي + إنجليزي'],
      missing:    ['رسائل غير محدودة', 'ماسح الباركود', 'إرشادات الأكل خارجاً'],
      cta:        'ابدأ مجاناً',
      href:       '/auth/signup',
      hero:       false,
    },
    {
      ...
      annualSAR: PRICING.pro.annual.sar,
      priceLabel: '',
      features:  ['رسائل Ion غير محدودة يومياً', 'كل مزايا المجاني', 'تجربة مجانية 7 أيام', 'ماسح باركود الطعام', 'إرشادات الأكل خارجاً ووصفات الوجبات', 'متابعة استباقية', 'تجديد الخطة الذكي', 'تخزين صور التقدم'],
