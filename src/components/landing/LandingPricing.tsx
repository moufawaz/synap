  ...
  plans: [
    {
      ...
      priceLabel: '7-day full access trial — free forever after',
      features:   ['✦ 7-day full access trial', '5 Ion messages / day after trial', 'Adaptive diet plan', 'Smart workout program', 'Body tracking (13 measurements)', 'Grocery list generator', 'Bilingual Arabic + English'],
      missing:    ['Unlimited messages', 'Food calories scanner', 'Eating out guidance'],
    ...
    },
    {
      ...
      priceLabel: '',
      features:  ['Unlimited Ion messages / day', 'Everything in Starter', '7-day free trial', 'Food calories scanner', 'Eating out & meal recipes', 'Proactive check-ins', 'Plan renewal that learns', 'Progress photo storage'],
      missing:   ['Goal timeline prediction', 'Weekly body report', 'Supplement protocol'],
    ...
    },
    {
      ...
      priceLabel: '',
      features:  ['Everything in Pro', '7-day free trial', 'Goal timeline prediction', 'Weekly body composition report', 'Weekly macro auto-adjustments', 'Supplement protocol', 'Exercise form check (AI photo)', 'First access to new features'],
      missing:   [] as string[],
      cta:       'Try Free for 7 Days',
      href:      '/pricing',
      hero:      false,
  ...
  plans: [
    {
      ...
      priceSAR:   null as number | null,
      annualSAR:  null as number | null,
      priceLabel: 'تجربة 7 أيام كاملة — مجاني للأبد بعدها',
      features:   ['✦ تجربة 7 أيام وصول كامل', '5 رسائل يومياً بعد التجربة', 'خطة غذائية تكيفية', 'برنامج تمرين ذكي', 'تتبع الجسم (13 قياساً)', 'مولّد قائمة التسوق', 'ثنائي اللغة عربي + إنجليزي'],
      missing:    ['رسائل غير محدودة', 'ماسح سعرات الطعام', 'إرشادات الأكل خارجاً'],
    ...
    },
    {
      ...
      annualSAR: PRICING.pro.annual.sar,
      priceLabel: '',
      features:  ['رسائل Ion غير محدودة يومياً', 'كل مزايا المجاني', 'تجربة مجانية 7 أيام', 'ماسح سعرات الطعام', 'إرشادات الأكل خارجاً ووصفات الوجبات', 'متابعة استباقية', 'تجديد الخطة الذكي', 'تخزين صور التقدم'],
      missing:   ['التنبؤ بالجدول الزمني للهدف', 'تقرير الجسم الأسبوعي', 'بروتوكول المكملات'],
    ...
    },
    {
      ...
      annualSAR: PRICING.elite.annual.sar,
      priceLabel: '',
      features:  ['كل مزايا برو', 'تجربة مجانية 7 أيام', 'التنبؤ بالجدول الزمني للهدف', 'تقرير تركيبة الجسم الأسبوعي', 'تعديل ماكرو أسبوعي تلقائي', 'بروتوكول المكملات الغذائية', 'فحص شكل التمرين (ذكاء اصطناعي)', 'أولوية الوصول للميزات الجديدة'],
      missing:   [] as string[],
      cta:       'جرب مجاناً 7 أيام',
      href:      '/pricing',
      hero:      false,
